...
describe Event do
  ...
  def reset_event(options = {})
    @valid_attributes = {
      :id => 1,
      :geocords => "RSpec is great for testing too"
    }
  ...
  context "validations" do
    ...
    it "rejects empty geocords" do
      Event.new(@valid_attributes.merge(:geocords => "")).should_not be_valid
    end

    it "rejects non unique geocords" do
